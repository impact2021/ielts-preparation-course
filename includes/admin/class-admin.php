...
class IELTS_CM_Admin {
    ...
    public function quiz_meta_box($post) {
        ...
        <p>
            ...
            <small><?php _e('Choose how results are displayed. For IELTS Reading/Listening, band scores are converted from correct answers. For IELTS Writing Assessment, the saved band score is shown directly (1.0–9.0), and out-of-range values are clamped. For CEFR, results are shown as A1–C2 levels.', 'ielts-course-manager'); ?></small>
        </p>
    ...
    public function save_meta_boxes($post_id) {
        ...
        if (isset($_POST['ielts_cm_quiz_meta_nonce']) && wp_verify_nonce($_POST['ielts_cm_quiz_meta_nonce'], 'ielts_cm_quiz_meta')) {
            ...
            if (isset($_POST['ielts_cm_scoring_type'])) {
                ...
                $valid_types = array('percentage', 'ielts_general_reading', 'ielts_academic_reading', 'ielts_listening', 'writing_assessment', 'cefr');
