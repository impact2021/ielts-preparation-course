    ...
    private function render_question_field($index, $question) {
        ...
        <div class="question-item" style="border: 1px solid #ddd; padding: 15px; margin-bottom: 15px; background: #f9f9f9; position: relative;">
            ...
            <div class="writing-task-settings" style="<?php echo (isset($question['type']) && $question['type'] === 'writing_task') ? '' : 'display:none;'; ?> padding: 15px; background: #f0f6fc; border-left: 4px solid #2271b1; margin-bottom: 15px;">
                ...
                <ul>
                    <li><small><?php _e('For Task 1 Academic image questions, the image is display-only. Add a text version of the chart or table data in the Question Text field so the AI can assess the student response correctly.', 'ielts-course-manager'); ?></small></li>
                    <li><small><?php _e('Include the chart title, categories, years, values, and any notes in the Question Text. The student sees the image, but the AI only receives the Question Text and the student answer.', 'ielts-course-manager'); ?></small></li>
                </ul>
            </div>
