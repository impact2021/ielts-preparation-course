...
class IELTS_CM_Admin {
    ...
    public function quiz_meta_box($post) {
        ...
        <p>
            ...
            <small><?php _e('Choose how results are displayed. For IELTS Reading/Listening, band scores are converted from correct answers. For IELTS Writing Assessment, the saved band score is shown directly. For CEFR, results are shown as A1–C2 levels.', 'ielts-course-manager'); ?></small>
        </p>
