...
<?php
$test_data = [
    'title' => 'summary-completion-test - Demo Summary Completion Questions (CBT)',
    'slug' => 'summary-completion-test-demo-cbt',
    'pass_percentage' => 60,
    ...
    'timer_minutes' => 5,
    'reading_texts' => [[
        'title' => 'Demo Reading Passage - Electric Vehicles',
        'content' => 'Electric vehicles (EVs) are transforming the automotive industry. They use rechargeable batteries instead of gasoline, producing zero direct emissions. Modern EVs can travel over 300 miles on a single charge, making them practical for daily use. The cost of batteries has decreased by 80% since 2010, making EVs more affordable. Governments worldwide offer incentives to encourage EV adoption, including tax credits and free parking.'
    ]],
    'questions' => [[
