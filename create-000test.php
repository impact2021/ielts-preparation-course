...
<?php
/**
 * Creates 000test.xml - A simple demo test with one T/F/NG question
 * 
 * Usage:
 *   php create-000test.php
 */

$test_data = [
    'title' => '000test - Demo T/F/NG Question',
    'slug' => '000test-demo-tfng',
    'pass_percentage' => 60,
    ...
    'reading_texts' => [
        [
            'title' => 'Demo Reading Passage - The Benefits of Reading',
            'content' => 'Reading is one of the most beneficial activities for mental development. Studies have shown that regular reading can improve vocabulary, enhance concentration, and reduce stress levels. Many successful people attribute their achievements to a habit of reading widely and consistently.

Research conducted at the University of Sussex found that reading for just six minutes can reduce stress by up to 68%. This makes reading more effective at stress reduction than listening to music, drinking tea, or going for a walk. The act of focusing on a narrative allows the mind to escape from daily worries and relax.

Furthermore, reading before bedtime has been shown to improve sleep quality. The routine of reading signals to the brain that it is time to wind down, making it easier to fall asleep. However, experts recommend using physical books rather than electronic devices, as the blue light from screens can interfere with sleep patterns.'
        ]
    ],
...
Question 1 is based on the Demo Reading Passage.',
            'question' => 'Reading for six minutes can reduce stress by up to 68%.',
            'points' => 1,
            'no_answer_feedback' => 'Look for information about stress reduction and the specific percentage mentioned in the passage.',
            'correct_feedback' => 'Correct! The passage clearly states that research at the University of Sussex found that reading for just six minutes can reduce stress by up to 68%.',
            'incorrect_feedback' => 'The passage explicitly mentions that research at the University of Sussex found reading for just six minutes can reduce stress by up to 68%.',
            'reading_text_id' => 0,
            'options' => '',
            'correct_answer' => 'true'
        ]
...
<!-- 000test Demo - Single T/F/NG Question -->
