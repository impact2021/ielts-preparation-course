...
<?php
/**
 * Creates short-answer-test.xml - A demo test with short answer questions (CBT Layout)
 * 
 * Usage:
 *   php create-short-answer-test.php
 */

$test_data = [
    'title' => 'short-answer-test - Demo Short Answer Questions (CBT)',
    'slug' => 'short-answer-test-demo-cbt',
    'pass_percentage' => 60,
    ...
    'reading_texts' => [
        [
            'title' => 'Demo Reading Passage - The Great Barrier Reef',
            'content' => 'The Great Barrier Reef, located off the coast of Queensland, Australia, is the world\'s largest coral reef system. Stretching over 2,300 kilometers, it comprises approximately 2,900 individual reefs and 900 islands. The reef was selected as a UNESCO World Heritage Site in 1981 due to its exceptional natural beauty and biological diversity.

Marine biologists estimate that the Great Barrier Reef is home to around 1,500 species of fish, 400 types of coral, and numerous other marine creatures including sea turtles, dolphins, and sharks. The reef generates approximately $6.4 billion annually for the Australian economy through tourism and fishing industries, supporting over 64,000 jobs.

However, the reef faces significant environmental challenges. Rising ocean temperatures have caused coral bleaching events, with the most severe occurring in 2016 and 2017. Scientists warn that without immediate action to reduce carbon emissions, up to 90% of the reef could be lost by 2050.'
        ]
    ],
...
Questions 1-2 are based on the Demo Reading Passage.',
            'question' => 'In what year was the Great Barrier Reef designated as a UNESCO World Heritage Site?',
            'points' => 1,
            'no_answer_feedback' => 'Look for information about UNESCO World Heritage Site designation.',
            'correct_feedback' => 'Correct! The passage states it was selected in 1981.',
            'incorrect_feedback' => 'The passage clearly states the reef was selected as a UNESCO World Heritage Site in 1981.',
            'reading_text_id' => 0,
            'options' => '',
            'correct_answer' => '1981'
        ],
        [
            'type' => 'short_answer',
            'instructions' => '',
            'question' => 'How many jobs does the Great Barrier Reef support in Australia?',
            'points' => 1,
            'no_answer_feedback' => 'Find the information about employment in the passage.',
            'correct_feedback' => 'Excellent! The passage mentions over 64,000 jobs.',
            'incorrect_feedback' => 'The passage states the reef supports over 64,000 jobs.',
            'reading_text_id' => 0,
            'options' => '',
            'correct_answer' => '64,000|64000|OVER 64,000|OVER 64000'
        ]
    ]
];
...
<!-- short-answer-test Demo - Short Answer Questions (CBT Layout) -->
...
// Output filename
$filename = 'short-answer-test.xml';
