<?php
/**
 * Template for displaying listening practice tests
 * Two-column layout with audio player on left (no controls, autoplay after countdown) and questions on right
 * Shows transcript after submission
 */
...
<div class="ielts-listening-practice-quiz" data-quiz-id="<?php echo $quiz->ID; ?>" data-course-id="<?php echo $course_id; ?>" data-lesson-id="<?php echo $lesson_id; ?>" data-timer-minutes="<?php echo esc_attr($timer_minutes); ?>" data-next-url="<?php echo esc_attr($next_url); ?>" data-audio-url="<?php echo esc_attr($audio_url); ?>">
                    ...
                    <div class="reading-content listening-audio-content">
                        ...
                        <div class="listening-audio-player listening-practice-player" id="listening-audio-player" style="display: none;">
                            ...
                            <div class="audio-status">
                                ...
                                <span class="audio-status-text"><?php _e('Audio Playing', 'ielts-course-manager'); ?></span>
                            </div>
                        </div>
                                    ...
                                    <div class="transcript-section-content" id="transcript-section-<?php echo esc_attr($index); ?>" style="<?php echo ($index !== $first_section_key) ? 'display:none;' : ''; ?>">
                                        <?php if (!empty($section['transcript'])): ?>
                                            <div class="transcript-content">
                                                ...
                                                $processed_transcript = process_transcript_markers_practice($section['transcript']);
                    ...
                    <div class="questions-content">
                        ...
                        ?>
                            <div class="quiz-question" id="question-<?php echo $index; ?>" data-display-start="<?php echo $display_nums['start']; ?>" data-display-end="<?php echo $display_nums['end']; ?>">
                                ...
                                // Don't display question text for dropdown_paragraph, summary_completion, table_completion, or closed_question_dropdown
